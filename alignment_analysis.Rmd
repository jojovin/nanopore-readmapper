...
```{r}
insertions_modified <- read.csv("/Users/au606858/nanopore-readmapper/nanopore-readmapper/output/mod_insert.csv")
insertions_unmodified <- read.csv("/Users/au606858/nanopore-readmapper/nanopore-readmapper/output/unmod_insert.csv")
